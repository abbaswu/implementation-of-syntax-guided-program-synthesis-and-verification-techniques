...
def verification_oracle(z3_input_variable_list, z3_function_declaration, z3_constraint):
    ...
    while True:
        ...
        if check_sat_result == z3.sat:
            ...
            z3_input_variables_to_values = { z3_input_variable: model_ref[z3_input_variable] for z3_input_variable in z3_input_variable_list }
